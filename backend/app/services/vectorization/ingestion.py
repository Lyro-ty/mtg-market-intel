...
Provides functions to vectorize cards and store feature vectors in the database.
Cards are vectorized using sentence-transformers for semantic similarity search.
"""
