...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('moderator_id', sa.Integer(), sa.ForeignKey('users.id', ondelete='SET NULL')),
    ...
    op.create_table(
        'moderation_notes',
        sa.Column('id', sa.Integer(), primary_key=True),
        sa.Column('moderator_id', sa.Integer(), sa.ForeignKey('users.id', ondelete='SET NULL'), nullable=False),
        sa.Column('target_user_id', sa.Integer(), sa.ForeignKey('users.id', ondelete='CASCADE'), nullable=False),
    ...
    op.create_table(
        'trade_disputes',
        sa.Column('id', sa.Integer(), primary_key=True),
        sa.Column('trade_proposal_id', sa.Integer(), sa.ForeignKey('trade_proposals.id', ondelete='SET NULL')),
        ...
        sa.Column('assigned_moderator_id', sa.Integer(), sa.ForeignKey('users.id', ondelete='SET NULL')),
